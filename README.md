...
Now, install [https://anaconda.org/bioconda/sra-tools](sra-tools "sra-tooks installtion page in conda"), [https://anaconda.org/bioconda/salmon](salnom "salmon installtion page in conda"). etc.
